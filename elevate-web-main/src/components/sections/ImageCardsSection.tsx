    ...
    <section className="dynamic-section w-full bg-[#1a1a1a] text-white py-20 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16 flex flex-col items-center">
          <h2 className="text-h2-bold uppercase tracking-widest mb-6 leading-tight">
            {preHeading && (
          ...
          {subHeading && (
            <p className="text-gray-300 text-h5 max-w-4xl mx-auto leading-relaxed">
              {subHeading}
            </p>
          )}
        </div>
              ...
              return (
                ...
                >
                  ...
                  {imageUrl && imageUrl !== "#" ? (
                    ...
                    <div className="relative w-full aspect-[4/3] mb-8 bg-gray-200 animate-pulse flex items-center justify-center text-gray-400 text-body">
                      No Image
                    </div>
                  )}
                  
                  {/* Title */}
                  <h3 className="text-body uppercase font-bold tracking-widest mb-4">
                    {card.title}
                  </h3>
                  
                  {/* Description */}
                  <p className="text-[#666666] text-h5 leading-relaxed mb-4">
